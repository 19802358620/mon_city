...
namespace Ge.Infrastructure.Utilities
{
    /// <summary>
    /// Js版本的DES加密、解密
    /// http://www.cnblogs.com/lczblog/p/5736965.html
    /// </summary>
    public class DesJsEncrypt
    {
        /// <summary>
        /// DES加密解密
        /// </summary>
        /// <returns></returns>
        public static string DES(string key, string strMessage, bool isEncrypt, int mode, string strIV)
        {
            if (strMessage == null || strMessage == string.Empty) return string.Empty;
        ...
        /// <returns></returns>
        public static int[] DES_CreateKey(string strKey)
        {
        ...
        /// <returns></returns>
        public static int MoveByte(int val, int pos)
        {
