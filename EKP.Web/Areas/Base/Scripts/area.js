(function ($) {
    ...
    for (var name in dsy.Items) {
        dsy.Items[name].unshift("请选择");
    }
    ...
    $.prototype.area = function (province, city, county) {
        ...
        for (i = 0; i < ar.length; i++) {
            $("#" + s[0])[0].options[i] = new Option(ar[i], ar[i] == "请选择" ? "" : ar[i]);
        }
        var pid = "";
        var cid = "";
        $("#" + s[0]).change(function () {
            pid = this.selectedIndex - 1;
            str = "0_" + pid;
            if (dsy.Exists(str)) {
                ar = dsy.Items[str];
                $("#" + s[1]).empty();
                for (i = 0; i < ar.length; i++) {
                    ...
                    $("#" + s[1])[0].options[i] = new Option(ar[i], ar[i] == "请选择" ? "" : ar[i]);
                }
                $("#" + s[1]).change();
            }
        });
        $("#" + s[1]).change(function () {
            cid = this.selectedIndex - 1; 
            str = "0_" + pid + "_" + cid
            ...
            if (dsy.Exists(str) && county) {
                ar = dsy.Items[str];
                $("#" + s[2]).empty();
                for (i = 0; i < ar.length; i++) {
                    {
                        $("#" + s[2])[0].options[i] = new Option(ar[i], ar[i] == "请选择" ? "" : ar[i]);
                    }
                }
            }
        });
