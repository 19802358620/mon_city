...
(function ($) {
   ...
   function GTreeTableCache(manager) {
    ...
    GTreeTableCache.prototype = {  
        _EKP_Jsgcwx: function (param) {
            return typeof param === "string" ? param : param.EKP_Jsgcwx();
        },
        
        get: function(param) {
            return this._cached[this._EKP_Jsgcwx(param)];
        },
        
        set: function (param, data) {
            this._cached[this._EKP_Jsgcwx(param)] = data;
        },
                
        remove: function (param) {
            this._cached[this._EKP_Jsgcwx(param)] = undefined;
        },
